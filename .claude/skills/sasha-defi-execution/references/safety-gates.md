...
## Gate 4 — kill switches (auto-protective, do not weaken)
- OOR > 240 min → CLOSE_REOPEN. HF < 1.20 warn / < 1.05 DELEVERAGE. Funding < −54.75% ann → hedge kill.
- These exist to protect capital autonomously; changing a threshold is a Gate-2 decision.
